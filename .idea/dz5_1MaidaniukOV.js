...
let arifmetsSrednyeARR = [1,2,3,4];
let arifmetsSrednye = (arifme) => {
    let arif = 0;
    for (const arifmeElement of arifme) {
        arif+=arifmeElement;
    }
    return arif/arifme.length;
}
console.log(arifmetsSrednye(arifmetsSrednyeARR));
